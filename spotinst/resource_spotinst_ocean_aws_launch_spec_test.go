		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "elastic_ip_pool.520786957.tag_selector.0.tag_key", "create key"),
					resource.TestCheckResourceAttr(resourceName, "elastic_ip_pool.520786957.tag_selector.0.tag_value", "create value"),
				),
			},
			{
				Config: createOceanAWSLaunchSpecTerraform(&LaunchSpecConfigMetadata{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testCheckOceanAWSLaunchSpecAttributes(&launchSpec, oceanID),
					resource.TestCheckResourceAttr(resourceName, "elastic_ip_pool.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "elastic_ip_pool.4038544314.tag_selector.0.tag_key", "update key"),
					resource.TestCheckResourceAttr(resourceName, "elastic_ip_pool.4038544314.tag_selector.0.tag_value", "update value"),
				),
			},
			{
				Config: createOceanAWSLaunchSpecTerraform(&LaunchSpecConfigMetadata{
